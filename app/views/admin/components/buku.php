            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASEURL ?>/admin/editbuku/<?= $book['id'] ?>" class="btn btn-warning btn-sm">Ubah</a>
                            <a href="<?= BASEURL ?>/admin/deletebuku/<?= $book['id'] ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
