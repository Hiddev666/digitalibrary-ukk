<div class="container p-3 ps-4">
    <div class="container card p-4">
        ...
        <div class="mt-3 d-flex align-items-center justify-content-between">
            <a href="<?= BASEURL ?>/admin/addpeminjaman">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="<?= BASEURL ?>/admin/laporanpeminjaman/<?= $peminjaman['id'] ?>" class="btn btn-primary btn-sm">Laporan</a>
                                <a href="<?= BASEURL ?>/admin/editpeminjaman/<?= $peminjaman['id'] ?>" class="btn btn-warning btn-sm">Ubah</a>
                                <a href="<?= BASEURL ?>/admin/deletepeminjaman/<?= $peminjaman['id'] ?>" class="btn btn-danger btn-sm">Hapus</a>

                                <?php
                                if ($peminjaman['status_peminjaman'] == "Dipinjam") { ?>
                                    <a href="<?= BASEURL ?>/admin/kembalikan/<?= $peminjaman['id'] ?>">
                                ...
                                <?php } elseif ($peminjaman['status_peminjaman'] == "Pending") { ?>
                                    <a href="<?= BASEURL ?>/admin/accept/<?= $peminjaman['id'] ?>">
                                        <img src="<?= BASEURL ?>/img/accept-check-good-mark-ok-tick-svgrepo-com.svg" alt="" style="width: 28px;">
                                    </a>
                                <?php } else { ?>
                                    <a href="<?= BASEURL ?>/admin/pinjamkan/<?= $peminjaman['id'] ?>">
